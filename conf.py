# -*- coding: utf-8 -*-
#
# HBP Neuromorphic Computing Platform Guidebook documentation build configuration file, created by
# sphinx-quickstart on Wed Jan  7 14:17:08 2015.
#
...
version = "{} ({})".format(version_string, repo_version)
# The full version, including alpha/beta/rc tags.
release = "{} ({})".format(version_string, repo_version)
...
# of the sidebar.
html_logo = 'HBP_Primary_RGB_logoOnlyScaled68px.png'
...
html_last_updated_fmt = '%b %d, %Y ' + '(%s, preliminary documentation)' % repo_version.rstrip(' \n')
...
version_string = datetime.datetime.utcnow().strftime('%Y%m%d%H%M%S')
filename_version = "{}_{}".format(version_string, repo_version)
latex_documents = [
  ('index', '%s-%s.tex' % (basename, filename_version), title,
